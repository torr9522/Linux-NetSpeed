...
KERNEL_MODE_NOTICE="卸载旧内核，并切换默认启动项"
PEER_SCRIPT_REMOTE_URL="https://raw.githubusercontent.com/torr9522/Linux-NetSpeed/tcpx.sh/tcpx.sh"
...
${Green_font_prefix}0.${Font_color_suffix} 切换到不卸载内核版本
